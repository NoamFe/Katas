...
namespace Algorithm.Test
{
    public class FinderTests
    {
        ...
        [Fact]
        public void Returns_EmptyResults_WhenGivenOnePerson()
        {
        ...
        [Fact]
        public void Returns_Two_WhenTwoPeopleAndCallWithClosest()
        {
        ...
        [Fact]
        public void Returns_Two_WhenTwoPeopleAndCallWithFurthest()
        {
            var list = new List<Person>() { greg, mike };
            var finder = new Finder(list);

            var result = finder.Find(TimeSpanFilter.Furthest);
        ...
        [Fact]
        public void Returns_FurthestTwo_WhenMoreThanTwoPeople()
        {
        ...
        [Fact]
        public void Returns_ClosestTwo_WhenMoreThanTwoPeople()
        {
            var list = new List<Person>() { greg, mike, sarah, sue };
            var finder = new Finder(list);
